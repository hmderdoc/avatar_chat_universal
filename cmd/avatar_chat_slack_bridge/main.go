...
import (
	...
	"github.com/hmderdoc/avatar_chat_universal/internal/slackbridge"
)

func main() {
	configPath := flag.String("config", "slack_bridge.ini", "path to bridge config")
	...
	cfg, err := slackbridge.LoadConfig(*configPath)
	if err != nil {
	...
	b := &slackbridge.Bridge{Config: cfg, Logger: log.Default()}
