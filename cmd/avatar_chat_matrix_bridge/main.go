...
import (
	...
	"github.com/hmderdoc/avatar_chat_universal/internal/matrixbridge"
)

func main() {
	configPath := flag.String("config", "matrix_bridge.ini", "path to bridge config")
	...
	cfg, err := matrixbridge.LoadConfig(*configPath)
	if err != nil {
	...
	b := &matrixbridge.Bridge{Config: cfg, Logger: log.Default()}
