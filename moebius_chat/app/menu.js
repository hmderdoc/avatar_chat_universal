...
function file_menu_template(win) {
    return {
        ...
        submenu: [
            ...
            {type: "separator"},
            {label: "Send to Chat", id: "send_to_chat", accelerator: "CmdorCtrl+Shift+C", click(item) {win.send("send_to_chat");}},
            {label: "Set Avatar from Canvas\u2026", id: "set_avatar_from_canvas", click(item) {win.send("set_avatar_from_canvas");}},
            {type: "separator"},
